...
For example:
```
python sim_trifinger.py --get_nerf_training_data --obj Obj_Fish_5e6656b0f124e0f38af30108ea9ccb6c_0_019030 --viewer --num_steps_before_collecting 50 --overwrite
```
"""
...
for acronym_object_class in tqdm(acronym_object_classes):
    command = f"python sim_trifinger.py --get_nerf_training_data --obj {acronym_object_class} --viewer --num_steps_before_collecting 50 --overwrite"
