...
def optimize_cem(
    cost, mu_0, Sigma_0, num_iters=25, num_samples=250, elite_frac=0.1, constraint=None
):
    """
...
def get_points_cem(
    nerf, n_f, mu_scale=5e-3, sigma_scale=1e-2, mu_0=None, Sigma_0=None, constraint=None
):
    ...
    mu_f, Sigma_f = optimize_cem(
        cost, mu_0, Sigma_0, num_iters=25, num_samples=500, constraint=constraint
    )
