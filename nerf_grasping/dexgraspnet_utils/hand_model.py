...
from nerf_grasping.dexgraspnet_utils.hand_model_type import HandModelType, handmodeltype_to_fingerkeywords
...
class HandModel:
    ...
    def _init_allegro(
        self,
        urdf_path=f"{nerf_grasping.get_package_root()}/allegro_hand_description/allegro_hand_description_right.urdf",
        contact_points_path=f"{nerf_grasping.get_package_root()}/allegro_hand_description/contact_points_precision_grasp_dense.json",
        penetration_points_path=f"{nerf_grasping.get_package_root()}/allegro_hand_description/penetration_points.json",
        n_surface_points=0,
    ):
        device = self.device
