...
# %%
mesh_N = trimesh.load_mesh("/juno/u/tylerlum/github_repos/nerf_grasping/nerf_grasping/baselines/nerf_meshdata/outputs/coacd/decomposed.obj")
mesh_Oy = mesh_N.copy()
...
# %%
path = pathlib.Path("/juno/u/tylerlum/github_repos/nerf_grasping/nerf_grasping/baselines/nerf_meshdata_rotated/outputs/coacd/decomposed.obj")
